...
import (
	...
	_ "github.com/waynz0r/protobuf/test/importcustom-issue389/imported"
	github_com_waynz0r_protobuf_test_importcustom_issue389_imported "github.com/waynz0r/protobuf/test/importcustom-issue389/imported"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type C struct {
	F2                   *github_com_waynz0r_protobuf_test_importcustom_issue389_imported.B `protobuf:"bytes,1,opt,name=f2,proto3,customtype=github.com/waynz0r/protobuf/test/importcustom-issue389/imported.B" json:"f2,omitempty"`
...
var fileDescriptor_7086c139101e99ef = []byte{
	...
	0x48, 0xcf, 0x2c, 0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x2f, 0x4f, 0xac, 0xcc, 0xab,
	0x32, 0x28, 0xd2, 0x07, 0x2b, 0x4a, 0x2a, 0x4d, 0xd3, 0x4f, 0xcf, 0x4f, 0xcf, 0x07, 0x73, 0xc0,
	...
	0xff, 0xff, 0x99, 0xc3, 0x63, 0x28, 0x1a, 0x01, 0x00, 0x00,
}
...
func NewPopulatedC(r randyC, easy bool) *C {
	this := &C{}
	if r.Intn(5) != 0 {
		this.F2 = github_com_waynz0r_protobuf_test_importcustom_issue389_imported.NewPopulatedB(r)
	}
	if !easy && r.Intn(10) != 0 {
...
func (m *C) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.F2 == nil {
				m.F2 = &github_com_waynz0r_protobuf_test_importcustom_issue389_imported.B{}
			}
