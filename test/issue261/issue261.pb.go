...
var fileDescriptor_35fa31fa2023935a = []byte{
	...
	0xff, 0x6c, 0x7c, 0x29, 0x99, 0x79, 0x01, 0x00, 0x00,
}
...
func (m *MapStdTypes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NullableDuration) > 0 {
		for k := range m.NullableDuration {
			...
			baseI := i
			if v != nil {
				n1, err1 := github_com_waynz0r_protobuf_types.StdDurationMarshalTo((*v), dAtA[i-github_com_waynz0r_protobuf_types.SizeOfStdDuration((*v)):])
				if err1 != nil {
					return 0, err1
				}
				i -= n1
