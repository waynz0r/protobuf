...
var fileDescriptor_750763c054810c1d = []byte{
	...
	0xd4, 0x82, 0x12, 0xe2, 0x7c, 0xe2, 0xa4, 0xf3, 0xe0, 0xa1, 0x1c, 0xe3, 0x8f, 0x87, 0x72, 0x8c,
	...
	0x39, 0x86, 0x09, 0x8f, 0xe5, 0x18, 0x92, 0xd8, 0xc0, 0xce, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff,
	0xff, 0x92, 0x9c, 0x11, 0xcb, 0x9e, 0x01, 0x00, 0x00,
}
...
func (m *DroppedWithoutGetters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n1, err1 := github_com_waynz0r_protobuf_types.StdTimeMarshalTo(m.Timestamp, dAtA[i-github_com_waynz0r_protobuf_types.SizeOfStdTime(m.Timestamp):])
	if err1 != nil {
		return 0, err1
	}
	i -= n1
